...
**Always install to ~/.attache/skills/ via learn_skill. Never install globally.**
...
Use the `uninstall_skill` tool with the skill's slug to remove it from `~/.attache/skills/`.
